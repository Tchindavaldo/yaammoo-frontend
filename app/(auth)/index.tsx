  ...
  return (
    <View style={styles.content}>
      <ImageBackground source={require('@/assets/blur3.jpg')} style={styles.cardBack} resizeMode="cover">
        ...
        <View style={[styles.cardGrid, isSmall && { marginTop: isExtraSmall ? -30 : -60 }]}>
                ...
                <View style={styles.ionGrid}>
                  ...
                  <View style={styles.row2}>
                    ...
                    <View style={styles.colTopIconG}>
                      <TouchableOpacity>
                        <Ionicons name="logo-google" size={24} color="#a65757" />
                      </TouchableOpacity>
                    </View>
                    <View style={styles.colTopIconW}>
                      <TouchableOpacity onPress={() => direct('phone')}>
                        <Ionicons name="logo-whatsapp" size={24} color="#a65757" />
                      </TouchableOpacity>
                    </View>
                  </View>

                  {/* Row 3: Email - Alignement ico1: 0 */}
                  ...
                  {/* Row 4: Password - Alignement ico1: 0 */}
                  ...
                  {!isSmall && (
                    <View style={styles.rowNoAccount}>
                      <View style={styles.colSize5}>
                        <Text style={styles.labelInscripLabel}>vous n'avez pas de compte ?</Text>
                      </View>
                    </View>
                  )}

                  {/* Augmentation de l'espace (Espace entre texte et bouton) */}
                  <View style={[styles.rowInscription, { marginTop: 15 }]}>
                     {isExtraSmall && (
                       <Text style={styles.labelInscripLabel}>vous n'avez pas de compte ?</Text>
                     )}
                     <TouchableOpacity style={styles.ionChip} onPress={() => direct('register')}>
                  ...
                  {!isSmall && (
                    <>
                      <View style={styles.rowConnectLabel}>
                         <Text style={styles.labelConnectAvec}>Connectez Vous Avec</Text>
                      </View>

                      <View style={styles.rowOtherConnect}>
                         <View style={styles.colSize1}>
                            <Ionicons name="logo-google" size={35} color="#a65757" />
                         </View>
                         <View style={styles.colSize5}>
                            <TouchableOpacity onPress={() => direct('phone')}>
                               <Ionicons name="logo-whatsapp" size={35} color="#a65757" style={{ left: 10 }} />
                            </TouchableOpacity>
                         </View>
                      </View>
                    </>
                  ...
                  {isSmall && !isExtraSmall && (
                    <View style={styles.colOtherConnectSmall}>
                        <Ionicons name="logo-google" size={35} color="#a65757" />
                        <TouchableOpacity onPress={() => direct('phone')}>
                           <Ionicons name="logo-whatsapp" size={35} color="#a65757" style={{ marginLeft: 30 }} />
                        </TouchableOpacity>
                    </View>
                  )}
...
const styles = StyleSheet.create({
  ...
  cardBlack: { ...StyleSheet.absoluteFillObject, backgroundColor: 'rgba(0,0,0,0.57)', zIndex: 10 },
  ...
  welcomeLabel: { fontSize: 50, color: 'white', fontWeight: 'bold', lineHeight: 55 },
  ...
  colTopIconG: { width: (Dimensions.get('window').width - 30) * (5/12), alignItems: 'flex-end', paddingRight: 9 },
  colTopIconW: { width: (Dimensions.get('window').width - 30) * (2/12), alignItems: 'center' },
  labelConnexion: { fontSize: 20, fontWeight: 'bold', color: 'white' },
  // Inputs: Alignement ico1: 0 (parfaitement aligné à gauche)
  row3: { position: 'relative', justifyContent: 'center', height: 60, marginTop: 5 },
  row4: { position: 'relative', justifyContent: 'center', height: 60, marginTop: 9 },
  ico1: { position: 'absolute', left: 0, zIndex: 101 }, // Correction ALIGNEMENT GAUCHE
  ico2: { position: 'absolute', right: 0, zIndex: 101, padding: 5 },
  ionInput: { height: 60, borderBottomWidth: 0.5, borderBottomColor: '#ffffff59', paddingLeft: 30, color: 'white', fontSize: 16 },
  // Action Row
  rowAction: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingVertical: 13 },
  ...
  // Inscription Section
  rowNoAccount: { marginTop: 9, width: (Dimensions.get('window').width - 30) * (5/12) },
  labelInscripLabel: { fontSize: 13, color: 'white' },
  rowInscription: { flexDirection: 'row', alignItems: 'center' }, // Augmenté via style inline au dessus (15px)
  ionChip: {
  ...
  rowOtherConnect: { flexDirection: 'row', alignItems: 'center', marginTop: 15 }, // Changé de -5 à 15 pour descendre les logos
  colSize1: { width: (Dimensions.get('window').width - 30) * (1/12), alignItems: 'center' },
  colSize5: { width: (Dimensions.get('window').width - 30) * (5/12), alignItems: 'flex-start' },
  colOtherConnectSmall: { flexDirection: 'row', justifyContent: 'center', paddingBottom: 15, marginTop: 10 },
});
