              ...
              <View style={styles.ionGrid}>
                ...
                <View style={styles.row2}>
                  ...
                  <View style={styles.colOtherConnectWrapper}>
                    ...
                    <TouchableOpacity
                      style={[styles.socialIconBtn, { marginLeft: 15 }]}
                  ...
                  <View style={styles.merchantSection}>
                    ...
                    >
                      <View
                        style={[
                          styles.checkbox,
                          isMerchant && styles.checkboxChecked,
                        ]}
                      >
                        {isMerchant && (
                    ...
                    <Text style={styles.merchantDesc}>
                      veiller cocher cette case si vous posseder un Fast Food et
                      souhaiter la digitaliser sur notre platform
                    </Text>
                  </View>
                )}
                ...
                <View style={styles.rowBtnNav}>
                  ...
                  <TouchableOpacity
                    style={[styles.ionButton, { marginLeft: 15 }]}
                    onPress={infos2ISCheck ? createUser : nextStep}
                    disabled={connect}
                  >
                    {connect ? (
