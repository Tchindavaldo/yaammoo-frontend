...
# SOURCE du script Xcode Cloud. Copie dans ios/ci_scripts/ par le plugin
# `plugins/withXcodeCloud.js` a chaque `expo prebuild` (qui vide ios/ depuis
# le SDK 57). Modifier CE fichier, jamais la copie dans ios/.
