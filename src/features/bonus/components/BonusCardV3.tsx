...
/**
 * Design V3 des bonus : minimaliste / épuré. Page en fond NEUTRE (géré par
 * UserBonusModal), cartes blanches propres SANS teinte de fond ; la couleur du
 * bonus ne sert que d'accent (barre de progression, bouton, sparkline, icône).
 * Fichier dédié : ne partage pas le fichier de BonusCardV2.
 */
export const BonusCardV3: React.FC<BonusCardV3Props> = ({ bonus, claimStatus = "idle", onClaim }) => {
  ...
  return (
    <View style={styles.root}>
      ...
      {/* Mini-cartes stats (sparkline + barre) — fond léger teinté */}
...
const styles = StyleSheet.create({
  ...
  mini: { flex: 1, backgroundColor: LIGHT, borderRadius: 16, padding: 10, gap: 2, overflow: "hidden" },
